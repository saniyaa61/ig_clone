...
class PowerSyncRepository {
  ...
  /// whether environment should be dev.
  final bool isDev;
  ...
  Future<void> _openDatabase() async {
    ...
    supabase.auth.onAuthStateChange.listen((data) async {
      ...
      if (event == AuthChangeEvent.signedIn ||
        ...
        // Implicate sign out - disconnect, but don't delete data
  ...
  /// Broadcats the [Supabase] auth state changes, whenever user signs/logs in.
  ...
  /// Sends a request to the [Supabase] hat ensured that the email exists.
  /// If it doesn't, it throws an error.
  /// 
  /// If the email exists, the reset password email is sent to the user.
  /// He can provide the token he got from the email he received along with
  /// a new password.
  /// 
